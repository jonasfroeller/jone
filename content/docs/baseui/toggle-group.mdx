---
title: Toggle Group
description: Base UI Toggle Group component
---
...
```tsx title="toggle-group/index.ts"
'use client';
...
| --- | --- | --- | --- |
| `value?` | `readonly Value[] \| undefined` | `-` | The open state of the toggle group represented by an array of the values of all pressed toggle buttons. This is the controlled counterpart of `defaultValue`. |
| `defaultValue?` | `readonly Value[] \| undefined` | `-` | The open state of the toggle group represented by an array of the values of all pressed toggle buttons. This is the uncontrolled counterpart of `value`. |
