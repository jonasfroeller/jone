---
title: Toggle
description: Base UI Toggle component
---
...
| `value?` | `Value \| undefined` | `-` | A unique string that identifies the toggle when used inside a toggle group. |
