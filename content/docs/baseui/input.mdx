---
title: Input
description: Base UI Input component
---
...
| --- | --- | --- | --- |
| `onValueChange?` | `Field.Control.Props['onValueChange'] \| undefined` | `-` | Callback fired when the `value` changes. Use when controlled. |
| `defaultValue?` | `Field.Control.Props['defaultValue'] \| undefined` | `-` | The default value of the input. Use when uncontrolled. |
| `value?` | `React.ComponentProps<'input'>['value'] \| undefined` | `-` | The value of the input. Use when controlled. |
