---
title: Radio Group
description: Base UI Radio Group component
---
...
```tsx title="radio-group/index.ts"
'use client';
...
| `value?` | `Value \| undefined` | `-` | The controlled value of the radio item that should be currently selected. To render an uncontrolled radio group, use the `defaultValue` prop instead. |
| `defaultValue?` | `Value \| undefined` | `-` | The uncontrolled value of the radio button that should be initially selected. To render a controlled radio group, use the `value` prop instead. |
| `onValueChange?` | `((value: Value, eventDetails: RadioGroup.ChangeEventDetails) => void) \| undefined` | `-` | Callback fired when the value changes. |
