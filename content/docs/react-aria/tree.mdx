---
title: Tree
description: React Aria Tree component
---
...
<ComponentPreview>
  <Tree aria-label="Files">
    <TreeItem title="src" icon={<IconFolder className="w-4 h-4 text-blue-500" />} />
    <TreeItem title="public" icon={<IconFolder className="w-4 h-4 text-orange-500" />} />
  </Tree>
</ComponentPreview>
