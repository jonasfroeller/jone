...
description: React Aria ColorSwatchPicker component
---

## Preview

<ComponentPreview>
  <ColorSwatchPicker label="Color" colors={['#ff0000', '#00ff00', '#0000ff', '#ffff00', '#ff00ff']} />
</ComponentPreview>

## Source Code

```tsx title="ColorSwatchPicker.tsx"
'use client';
