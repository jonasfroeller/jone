---
title: ColorThumb
description: React Aria ColorThumb component
---

## Preview

<ComponentPreview>
  <p className="text-fd-muted-foreground text-sm">ColorThumb is used internally by color components.</p>
</ComponentPreview>

## Source Code

```tsx title="ColorThumb.tsx"
'use client';
