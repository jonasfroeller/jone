---
title: Toast
description: React Aria Toast component
---

## Preview

<ComponentPreview>
  <p className="text-fd-muted-foreground text-sm">Toast requires a global queue setup: see source code below for the implementation.</p>
</ComponentPreview>
