...
const cardContents = {
  ...
  design: (
    <div className="w-min box-border flex flex-col gap-2 p-2">
      <img
        width="250"
        height="249" className="block rounded-xs max-w-none"
  ...
  art: (
    <div className="w-min box-border flex flex-col gap-2 p-2">
      <img
        width="250"
        height="290" className="block rounded-xs max-w-none"
        ...
        {({ payload }) => (
          <PreviewCard.Portal>
            <PreviewCard.Positioner
              sideOffset={8} className="h-[var(--positioner-height)] w-[var(--positioner-width)] max-w-[var(--available-width)] transition-[top,left,right,bottom,transform] duration-[0.35s] ease-[cubic-bezier(0.22,1,0.36,1)]"
            >
              <PreviewCard.Popup className="box-border relative w-[var(--popup-width,auto)] h-[var(--popup-height,auto)] rounded-lg bg-[canvas] origin-[var(--transform-origin)] transition-[width,height,opacity,scale] duration-[0.35s] ease-[cubic-bezier(0.22,1,0.36,1)] data-[starting-style]:scale-90 data-[starting-style]:opacity-0 data-[ending-style]:scale-90 data-[ending-style]:opacity-0 shadow-lg shadow-fd-foreground/10 outline-1 outline-fd-border">
