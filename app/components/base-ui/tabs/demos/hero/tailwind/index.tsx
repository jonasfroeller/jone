...
export default function ExampleTabs() {
  return (
    <Tabs.Root className="rounded-md border border-fd-border" defaultValue="overview">
      <Tabs.List className="relative z-0 flex gap-1 px-1 shadow-[inset_0_-1px] shadow-fd-foreground/10">
        <Tabs.Tab className="flex h-8 items-center justify-center border-0 px-2 text-sm font-medium break-keep whitespace-nowrap text-fd-muted-foreground outline-hidden select-none before:inset-x-0 before:inset-y-1 before:rounded-xs before:-outline-offset-1 before:outline-fd-primary hover:text-fd-foreground focus-visible:relative focus-visible:before:absolute focus-visible:before:outline focus-visible:before:outline-2 data-[active]:text-fd-foreground"
          value="overview"
        >
          Overview
        </Tabs.Tab>
        ...
        <Tabs.Indicator className="absolute top-1/2 left-0 z-[-1] h-6 w-[var(--active-tab-width)] translate-x-[var(--active-tab-left)] -translate-y-1/2 rounded-xs bg-fd-muted transition-all duration-200 ease-in-out" />
      </Tabs.List>
      <Tabs.Panel className="relative flex h-32 items-center justify-center -outline-offset-1 outline-fd-primary focus-visible:rounded-md focus-visible:outline-2"
        value="overview"
      >
        <OverviewIcon className="size-10 text-fd-muted" />
      </Tabs.Panel>
      <Tabs.Panel className="relative flex h-32 items-center justify-center -outline-offset-1 outline-fd-primary focus-visible:rounded-md focus-visible:outline-2"
        value="projects"
      >
        <ProjectIcon className="size-10 text-fd-muted" />
      </Tabs.Panel>
      <Tabs.Panel className="relative flex h-32 items-center justify-center -outline-offset-1 outline-fd-primary focus-visible:rounded-md focus-visible:outline-2"
        value="account"
      >
        <PersonIcon className="size-10 text-fd-muted" />
      </Tabs.Panel>
    </Tabs.Root>
  );
}
