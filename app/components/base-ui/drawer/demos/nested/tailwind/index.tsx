        ...
        <Drawer.Viewport className="fixed inset-0 flex items-end justify-center">
          <Drawer.Popup className={popupClassName}>
            ...
            <Drawer.Content className={contentClassName}>
              ...
              <Drawer.Description className="mb-6 text-base text-fd-muted-foreground text-center">
              ...
              <div className="flex items-center justify-end gap-4">
                <div className="mr-auto">
                  <Drawer.Root>
                    <Drawer.Trigger className="text-base font-medium text-fd-primary rounded px-1.5 py-0.5 -m-0.5 hover:bg-fd-primary/5 active:bg-fd-primary/10 focus-visible:outline focus-visible:outline-2 focus-visible:-outline-offset-1 focus-visible:outline-fd-primary">
                      Security settings
                    </Drawer.Trigger>
                    <Drawer.Portal>
                      <Drawer.Viewport className="fixed inset-0 flex items-end justify-center">
                        <Drawer.Popup className={popupClassName}>
                          ...
                          <Drawer.Content className={contentClassName}>
                            ...
                            <ul className="mb-6 list-disc pl-5 text-fd-foreground">
                                      ...
                                      <Drawer.Popup className={popupClassName}>
                                        ...
                                        <Drawer.Content className={contentClassName}>
                                          ...
                                          <div className="grid gap-1.5 mb-4">
                                            ...
                                            <input
                                              id="device-name-tw" className="w-full rounded-md border border-fd-border bg-fd-background px-2.5 py-2 text-fd-foreground focus-visible:outline focus-visible:outline-2 focus-visible:-outline-offset-1 focus-visible:outline-fd-primary"
                                          ...
                                          <div className="grid gap-1.5 mb-6">
                                            ...
                                            <textarea
                                              id="notes-tw" className="w-full rounded-md border border-fd-border bg-fd-background px-2.5 py-2 text-fd-foreground resize-y focus-visible:outline focus-visible:outline-2 focus-visible:-outline-offset-1 focus-visible:outline-fd-primary"
                                          ...
                                          <div className="flex justify-end">
                                            <Drawer.Close className="flex h-10 items-center justify-center rounded-md border border-fd-border bg-fd-background px-3.5 text-base font-medium text-fd-foreground select-none hover:bg-fd-muted focus-visible:outline focus-visible:outline-2 focus-visible:-outline-offset-1 focus-visible:outline-fd-primary active:bg-fd-muted">
                                              Done
                                            </Drawer.Close>
                                          </div>
                                        </Drawer.Content>
...
const handleClassName =
  'mx-auto mb-4 h-1 w-12 rounded-full bg-fd-accent transition-opacity duration-[200ms] group-data-[nested-drawer-open]/popup:opacity-0 group-data-[nested-drawer-swiping]/popup:opacity-100';
