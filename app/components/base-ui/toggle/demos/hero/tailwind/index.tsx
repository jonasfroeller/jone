...
export default function ExampleToggle() {
  return (
    <div className="flex gap-px rounded-md border border-fd-border bg-fd-background p-0.5">
      <Toggle
        aria-label="Favorite" className="flex size-8 items-center justify-center rounded-xs text-fd-muted-foreground select-none hover:bg-fd-muted focus-visible:bg-none focus-visible:outline-2 focus-visible:-outline-offset-1 focus-visible:outline-fd-primary active:bg-fd-accent data-[pressed]:text-fd-foreground"
        render={(props, state) => {
          if (state.pressed) {
            return (
