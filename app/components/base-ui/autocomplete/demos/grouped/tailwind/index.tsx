  ...
  return (
    <Autocomplete.Root items={groupedTags}>
      <label className="flex flex-col gap-1 text-sm leading-5 font-medium text-fd-foreground">
        Select a tag
        <Autocomplete.Input
          placeholder="e.g. feature" className="bg-[canvas] h-10 w-[16rem] md:w-[20rem] font-normal rounded-md border border-fd-border pl-3.5 text-base text-fd-foreground focus:outline-2 focus:-outline-offset-1 focus:outline-fd-primary"
        />
      </label>

      <Autocomplete.Portal>
        <Autocomplete.Positioner className="outline-hidden" sideOffset={4}>
          <Autocomplete.Popup className="w-[var(--anchor-width)] max-h-[22.5rem] max-w-[var(--available-width)] rounded-lg bg-[canvas] text-fd-foreground outline-1 outline-fd-border shadow-lg shadow-fd-foreground/10">
