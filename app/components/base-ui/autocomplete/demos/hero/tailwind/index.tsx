    ...
    <Autocomplete.Root items={tags}>
      ...
      <Autocomplete.Portal>
        <Autocomplete.Positioner className="outline-hidden" sideOffset={4}>
          <Autocomplete.Popup className="w-[var(--anchor-width)] max-h-[23rem] max-w-[var(--available-width)] rounded-md bg-[canvas] text-fd-foreground shadow-lg shadow-fd-foreground/10 outline-1 outline-fd-border">
            <Autocomplete.Empty className="p-4 text-[0.925rem] leading-4 text-fd-muted-foreground empty:m-0 empty:p-0">
              No tags found.
            </Autocomplete.Empty>
