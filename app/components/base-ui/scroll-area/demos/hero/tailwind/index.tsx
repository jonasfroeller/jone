...
export default function ExampleScrollArea() {
  return (
    <ScrollArea.Root className="h-[8.5rem] w-96 max-w-[calc(100vw-8rem)]">
      <ScrollArea.Viewport className="h-full rounded-md outline-1 -outline-offset-1 outline-fd-border focus-visible:outline-2 focus-visible:outline-fd-primary">
        <div className="flex flex-col gap-4 py-3 pr-6 pl-4 text-sm leading-[1.375rem] text-fd-foreground">
          <p>
      ...
      <ScrollArea.Scrollbar className="m-2 flex w-1 justify-center rounded-sm bg-fd-accent opacity-0 transition-opacity pointer-events-none data-[hovering]:opacity-100 data-[hovering]:delay-0 data-[hovering]:pointer-events-auto data-[scrolling]:opacity-100 data-[scrolling]:duration-0 data-[scrolling]:pointer-events-auto">
