...
export default function ExampleTooltip() {
  return (
    <Tooltip.Provider>
      <div className="flex border border-fd-border rounded-md bg-fd-background p-0.5">
        <Tooltip.Root>
          <Tooltip.Trigger className="flex size-8 items-center justify-center border-0 rounded-xs bg-transparent text-fd-foreground select-none data-popup-open:bg-fd-muted focus-visible:bg-none focus-visible:outline-2 focus-visible:-outline-offset-1 focus-visible:outline-fd-primary hover:bg-fd-muted active:bg-fd-accent focus-visible:not-[&:hover]:bg-transparent"
          >
            <BoldIcon aria-label="Bold" className="size-4" />
          </Tooltip.Trigger>
          <Tooltip.Portal>
            <Tooltip.Positioner sideOffset={10}>
              <Tooltip.Popup className="flex flex-col px-2 py-1 rounded-md bg-[canvas] text-sm origin-(--transform-origin) shadow-lg shadow-fd-foreground/10 outline-1 outline-fd-border transition-[transform,scale,opacity] data-ending-style:opacity-0 data-ending-style:scale-90 data-instant:transition-none data-starting-style:opacity-0 data-starting-style:scale-90"
              >
