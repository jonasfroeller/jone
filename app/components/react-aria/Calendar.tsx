  ...
  return (
    <header className="flex items-center gap-1 pb-4 px-1 border-box">
      <Button variant="quiet" slot="previous">
        {direction === 'rtl' ? <ChevronRight aria-hidden width={18} height={18} /> : <ChevronLeft aria-hidden width={18} height={18} />}
      </Button>
      ...
      <Button variant="quiet" slot="next">
        {direction === 'rtl' ? <ChevronLeft aria-hidden width={18} height={18} /> : <ChevronRight aria-hidden width={18} height={18} />}
      </Button>
    </header>
  );
}
